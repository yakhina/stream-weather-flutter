...
//Technically it's almost a 100% copy of the original file, reused for the purpose of the technical assignment
//https://github.com/GetStream/stream-chat-flutter/blob/master/packages/stream_chat/lib/src/client/retry_policy.dart
...
class RetryPolicy {
  ...
  final FutureOr<bool> Function(
    StreamWeatherClient client,
    int attempt,
    StreamWeatherError? error,
  ) shouldRetry;
}