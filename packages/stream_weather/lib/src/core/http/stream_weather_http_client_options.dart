part of 'stream_weather_http_client.dart';

const _defaultBaseURL = 'https://api.openweathermap.org';

/// Client options to modify [StreamWeatherHttpClient]
class StreamWeatherHttpClientOptions {
  /// Instantiates a new [StreamWeatherHttpClientOptions]
  const StreamWeatherHttpClientOptions({
    String? baseUrl,
