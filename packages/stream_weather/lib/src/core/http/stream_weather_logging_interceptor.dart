...
//Technically it's a 100% copy of the original file, reused for the purpose of the technical assignment
//https://github.com/GetStream/stream-chat-flutter/blob/master/packages/stream_chat/lib/src/core/http/interceptor/logging_interceptor.dart
